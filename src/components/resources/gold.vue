...
<template>
    <div class="resources-item gold" @mouseenter="showTooltip = true" @mouseleave="showTooltip = false">
        <svg class="gold-image" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="coins" role="img"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path class="" fill="rgba(245,158,11,1)"
        ...
        <div class="gold-number" :class="{ 'negative-number': gold.total.value < 0 }">{{ convertToInteger(gold.total.value) }}
        </div>
